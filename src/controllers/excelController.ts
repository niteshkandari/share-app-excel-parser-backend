...
class ExcelController {
  async uploadExcel(req: Request, res: Response, next: NextFunction, type: string, prismaModel: any) {
    const file = req.file;
    if (!file) {
  ...
  uploadFundamentals = (req: Request, res: Response, next: NextFunction) =>
    this.uploadExcel(req, res, next, "FUNDAMENTAL", prismaClient.recordFundamentals);

  uploadFinancialIncomeExcel = (req: Request, res: Response, next: NextFunction) =>
    this.uploadExcel(req, res, next, "FINANCIAL_INCOME_STATEMENT", prismaClient.recordFinancialStatemetIncome);

  uploadFinancialBalanceExcel = (req: Request, res: Response, next: NextFunction) =>
    this.uploadExcel(req, res, next, "FINANCIAL_BALANCE_SHEET", prismaClient.recordFinancialBalanceSheet);

  uploadFinancialCashFlowStatementExcel = (req: Request, res: Response, next: NextFunction) =>
    this.uploadExcel(req, res, next, "FINANCIAL_CASHFLOW_SHEET", prismaClient.recordCashFlowStatement);

  uploadShareholdingPattern = (req: Request, res: Response, next: NextFunction) =>
    this.uploadExcel(req, res, next, "SHAREHOLDING_PATTERN", prismaClient.recordShareholdingPattern);
